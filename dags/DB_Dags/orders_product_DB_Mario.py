...
TARGET_DATE_NODASH = "20250826"  # For file paths
...
with DAG(
    ...
    for table_name, pg_table in TABLES.items():
        ...
        extract_to_gcs = PostgresToGCSOperator(
            ...
            bucket=BUCKET,
            filename=f"orders_products_db_snapshot_mario/{table_name}/dt={TARGET_DATE}/{table_name}.parquet",
        ...
        load_to_stage = GCSToBigQueryOperator(
            ...
            bucket=BUCKET,
            source_objects=[f"orders_products_db_snapshot_mario/{table_name}/dt={TARGET_DATE}/{table_name}.parquet"],
